...
export const SUGGESTED_CODES = ['EN', 'FR', 'HU', 'DE', 'ES', 'PT', 'IT', 'NL', 'DA', 'SV', 'NB', 'IS', 'GA', 'PL', 'CS', 'SK', 'RO', 'HR', 'SR', 'SL', 'BS', 'MK', 'SQ', 'BG', 'ET', 'LV', 'LT', 'EL', 'MT', 'ME'];
...
export const ALL_LANGUAGES: LangOption[] = [
  ...
  { code: 'ET', native: 'Eesti',          english: 'Estonian',     available: true  },
  ...
  { code: 'LT', native: 'Lietuvių',       english: 'Lithuanian',   available: true  },
  { code: 'LV', native: 'Latviešu',       english: 'Latvian',      available: true  },
  { code: 'ME', native: 'Crnogorski',     english: 'Montenegrin',  available: true  },
  { code: 'MK', native: 'Македонски',     english: 'Macedonian',   available: true  },
  { code: 'MT', native: 'Malti',          english: 'Maltese',      available: true  },
