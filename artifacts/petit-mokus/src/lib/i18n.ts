...
export const dictionary = {
  ...
  gameAnimalsClues: {
    dog:      { EN: 'My nose is 100,000× better than yours — I can sniff out hidden treats!',         FR: 'Mon nez est 100 000× plus fort que le tien — je sens les friandises cachées !',           HU: 'Az orrom 100 000-szer jobb, mint a tiéd — megérzem az elrejtett finomságokat!' },
    cat:      { EN: 'I can jump 6 times my own height — a true ninja acrobat!',                       FR: 'Je peux sauter 6× ma taille — un vrai ninja acrobate !',                                  HU: 'Saját magasságom 6-szorosát ugrálom — igazi nindzsával vetekedek!'             },
    horse:    { EN: 'I sleep standing up and am always ready to gallop!',                              FR: 'Je dors debout et suis toujours prêt à galoper !',                                        HU: 'Állva alszom, és mindig készen állok a vágtára!'                               },
    cow:      { EN: 'I have a best friend and feel sad when we are apart!',                            FR: "J'ai une meilleure amie et je m'ennuie quand elle n'est pas là !",                        HU: 'Legjobb barátom van, és szomorkodok, ha nincs mellettem!'                      },
    fox:      { EN: 'I can climb trees even better than cats!',                                        FR: 'Je grimpe aux arbres encore mieux que les chats !',                                       HU: 'Jobban mászok fára, mint a macskák!'                                           },
    wolf:     { EN: 'I live and hunt in a close family pack!',                                         FR: 'Je vis et chasse en famille très soudée !',                                               HU: 'Szoros csapatban élek és vadászom a családommal!'                              },
    squirrel: { EN: 'I bury nuts for a snack later — then forget exactly where!',                      FR: "J'enterre des noix pour plus tard... et j'oublie où !",                                   HU: 'Elások diót uzsonnára — aztán elfelejtem, hol!'                                },
    pig:      { EN: 'I can sniff out food buried underground with my sensitive nose!',                  FR: 'Mon groin ultra-sensible trouve de la nourriture cachée sous terre !',                    HU: 'Érzékeny orrommal megtalálom a föld alá rejtett ételt!'                        },
    sheep:    { EN: 'I remember 50 faces — sheep or human — for over 2 years!',                        FR: 'Je me souviens de 50 visages pendant plus de 2 ans — je n\'oublie jamais mes amis !',    HU: '50 arcot emlékezek 2 évig — barátaim sosem esnek ki a fejemből!'              },
    rooster:  { EN: 'I crow every single morning to wake my friends!',                                  FR: 'Je chante chaque matin pour réveiller mes amis !',                                        HU: 'Minden reggel kukorékólok, hogy felélesszem barátaimat!'                       },
  },
  songs: {
  ...
  ui: {
    ...
    gameFindLabel:       { EN: 'Find Match',                    FR: 'Trouve la paire',                HU: 'Keresd a párját'        },
    ...
    gameAnimalsLabel:        { EN: 'Animals',                          FR: 'Animaux',                              HU: 'Állatok'                         },
    gameAnimalsInstruction1: { EN: 'Find the same animal!',             FR: 'Trouve le même animal !',              HU: 'Keresd az egyforma állatot!'     },
    gameAnimalsInstruction2: { EN: 'Which animal made that sound?',     FR: 'Quel animal a fait ce bruit ?',        HU: 'Melyik állat adta ezt a hangot?' },
    gameAnimalsInstruction5: { EN: 'Who am I?',                         FR: 'Qui suis-je ?',                        HU: 'Ki vagyok én?'                   },
    gameAnimalsPlaySound:    { EN: 'Hear the sound again',              FR: 'Réécouter le son',                     HU: 'Hang meghallgatása'               },
    gameAnimalsListenSound:  { EN: 'Hear the sound',                    FR: 'Écoute le son',                        HU: 'Hallgasd meg a hangot'            },
    gameFlagsLabel: { EN: 'Flags',                          FR: 'Drapeaux',                          HU: 'Zászlók'                             },
    gameFlagsFind:  { EN: 'Find the same flag!',            FR: 'Trouve le même drapeau !',           HU: 'Keresd az egyforma zászlót!'         },
    gameFlagsMatch: { EN: 'Find the flag for the country!', FR: 'Trouve le drapeau du pays !',        HU: 'Keresd az ország zászlóját!'         },
    ...
    gameFilterHelp:  { EN: 'Showing games designed for age+ year olds.', FR: 'Jeux conçus pour les enfants de age+ ans.', HU: 'Játékok age+ éves gyerekeknek.' },
    ...
    newsletterTitle:            { EN: 'Stay in the loop',                            FR: 'Restez dans la boucle',                            HU: 'Maradj naprakész'                                    },
    ...
    newsletterEmailPlaceholder: { EN: 'Your email address',                           FR: 'Votre adresse e-mail',                             HU: 'E-mail címed'                                        },
    newsletterSubmit:           { EN: 'Subscribe',                                    FR: "S'abonner",                                        HU: 'Feliratkozás'                                        },
    newsletterSuccess:          { EN: 'Welcome to the Mokus family! 🐿',              FR: 'Bienvenue dans la famille Mokus ! 🐿',              HU: 'Üdv a Mokus családban! 🐿'                           },
    newsletterSuccessSub:       { EN: "You'll hear from us when something lovely is ready.", FR: 'Nous vous écrirons quand quelque chose de beau sera prêt.', HU: 'Írunk, ha valami szép készen van.'             },
    newsletterAlready:          { EN: "You're already on the list.",                  FR: 'Vous êtes déjà inscrit.',                          HU: 'Már fel vagy iratkozva.'                              },
    newsletterError:            { EN: 'Something went wrong — please try again.',     FR: 'Une erreur est survenue — veuillez réessayer.',    HU: 'Valami hiba történt — próbáld újra.'                 },
